...
public class Massactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_massactivity);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TV.setText(String.valueOf(convert * 2.2046226));
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Double convert = Double.parseDouble(ET.getText().toString());
                TV.setText(String.valueOf(convert * 1000000));
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Double convert = Double.parseDouble(ET.getText().toString());
                TV.setText(String.valueOf(convert * 0.001));
            }
        });
