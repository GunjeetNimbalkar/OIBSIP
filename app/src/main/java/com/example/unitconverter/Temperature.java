    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TV.setText(String.valueOf(convert + 273.15));
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Double convert = Double.parseDouble(ET.getText().toString());
                TV.setText(String.valueOf((convert * 1.8 ) + 32));
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Double convert = Double.parseDouble(ET.getText().toString());
                TV.setText(String.valueOf(convert * 0.80000));
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Double convert = Double.parseDouble(ET.getText().toString());
                TV.setText(String.valueOf((convert + 273.15) * 1.8));
            }
        });
